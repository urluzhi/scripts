#!/bin/sh
cp='.:jfreechart-1.0.13.jar:itext-1.4.3.jar:jcommon-1.0.16.jar'
infiles='data/Embryo.txt data/L1.txt data/L2.txt data/L3.txt data/L4.txt data/Young_Adult_Male.txt data/Young_Adult.txt data/Day0.txt data/Day5.txt data/Day8.txt data/Day12.txt'
