...
short int nnopair,nmod,mod[maxforce],*nopair;
short int nopairmax;
short int ngu,gu[maxgu];
char *nucs;
bool intermolecular,allocated,nopair_allocated,templated,stacking;
...
void checknopair();//check if the number of nopair larger than 1000-1
...
void ReadSHAPE(char *filename, bool calculate=true);//Read SHAPE reactivity data from a file
