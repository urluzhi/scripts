//This file will have s=1 to calculate suboptimal structure for unconstrained target,
//and optimal structure for constrained target
//									---Oct.11, 2006    John
...
void olig(bool isdna, int option, structure *ct, int length,double c, int **table,int **numofsubstructures,
		  ...
		  thermo* helixstack,int start, int stop, siPREFILTER *prefilter,int foldsize,int distance,int *TEST) {
