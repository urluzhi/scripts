...
public:
	...
	void refill(structure *CT,PFPRECISION *Qc, int start, int stop,char *save=NULL);
	...
	void scanconstrain(structure *CT,PFPRECISION *Qc,int start, int stop,char *save=NULL);
