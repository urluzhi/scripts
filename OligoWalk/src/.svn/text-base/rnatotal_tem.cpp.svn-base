...
{
strcpy (loop,"../../NN_data/loop.dat");
strcpy (stackf,"../../NN_data/stack.dat");
strcpy (tstackh,"../../NN_data/tstackh.dat");
strcpy (tstacki,"../../NN_data/tstacki.dat");
strcpy (tloop,"../../NN_data/tloop.dat");
strcpy (miscloop,"../../NN_data/miscloop.dat");
strcpy (danglef,"../../NN_data/dangle.dat");
strcpy (int22,"../../NN_data/int22.dat");
strcpy (int21,"../../NN_data/int21.dat");
strcpy (coax,"../../NN_data/coaxial.dat");
strcpy (tstackcoax,"../../NN_data/tstackcoax.dat");
strcpy (coaxstack,"../../NN_data/coaxstack.dat");
strcpy (tstack,"../../NN_data/tstack.dat");
strcpy (tstackm,"../../NN_data/tstackm.dat");
strcpy (triloop,"../../NN_data/triloop.dat");
strcpy (int11,"../../NN_data/int11.dat");
strcpy (hexaloop,"../../NN_data/hexaloop.dat");
strcpy (tstacki23,"../../NN_data/tstacki23.dat");
strcpy (tstacki1n,"../../NN_data/tstacki1n.dat");
}
