							...
							//data files
{
 ...
 float RT;
/* eparam[5]: a for multibranch loops  (a + b* (increasing per nucleotide) +c(per helix)
   eparam[6]: b for multibranch loops  
   eparam[10]: c for multibranch loops  
...
int erg2in(int i,int j,int ip,int jp,structure *ct,datatable *data);
		//calculates energy of the interior part of a internal loop
		//including (first mismatch bonus + gu/au penalty) of interior pair + assymmetry penalty
